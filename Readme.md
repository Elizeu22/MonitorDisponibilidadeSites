...
📌 Descrição
      ...
      Este projeto consiste em uma automação para monitoramento de disponibilidade que verifica periodicamente
      se um endereço eletrônico (site ou serviço de e-mail) está online.
